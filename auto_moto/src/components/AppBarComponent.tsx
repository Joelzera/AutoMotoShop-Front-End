    ...
    return (
        ...
        <AppBar position="fixed"
            ...
            <Toolbar>
                ...
                <Box sx={{ flexGrow: 0.5 }}>
                    <Button sx={{ marginLeft: 1, fontFamily: 'cursive', color: '#a0a0a0', fontWeight: 700 }} >Comprar</Button>
                    <Button sx={{ marginLeft: 1, fontFamily: 'cursive', color: '#a0a0a0', fontWeight: 700 }}>Vender</Button>
                </Box>
                <Button variant="contained" size="small" sx={{ backgroundColor: '#3b06b6', color: "fff", fontFamily: 'cursive' }}>Entrar</Button>
            </Toolbar>
        </AppBar>
    )
}
